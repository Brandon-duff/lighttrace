...
<p align="center">
  <a href="https://highlight.io/docs">Docs</a> - <a href="https://highlight.io/community">Community (Support & Feedback)</a> 
</p>
...
```bash
git clone --recurse-submodules https://github.com/Brandon-duff/lighttrace
...
To get started with these SDKs, we recommend the [getting started guide](https://www.highlight.io/docs/getting-started/overview) in our docs.
